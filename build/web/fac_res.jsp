...
<div class="container" id="app">
                  ...
                  <div class="card-header container-luid"">
                    <div class="row justify-content-between">
                              ...
                              <div class="btn-group col-4" role="group" aria-label="Basic example">
                                    <button type="button" class="btn btn-danger btn-sm" onclick="eliminar(<%=factura.getFaclId() %>);">Eliminar</button>
                              </div>
                        </div>
                 </div>
                  <div class="card-body">
       ...
       function eliminar(id){
        var r = confirm("Desea eliminar la factura?");
          if (r == true) {
            window.location.href='Controller?controller=Factura&action=eliminar&id='+id;
          } else {
