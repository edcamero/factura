...
public class Facturacliente  implements java.io.Serializable {
    ...
    public String toString() {
        return "Facturacliente{" + "faclId=" + faclId + ", cliente=" + cliente + ", faclTotal=" + faclTotal + ", faclFecha=" + faclFecha + ", faclFechacambio=" + faclFechacambio + ", faclRegistradopor=" + faclRegistradopor + ", detallefacturas=" + '}';
    }
